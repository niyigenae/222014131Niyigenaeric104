...
public class loginform extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("login with your ditails ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql="SELECT * FROM new_member WHERE Names=? AND Password=? AND Email=?";
        ...
        if(rs.next()){
            ...
            JOptionPane.showInternalMessageDialog(null,"failed");
        }
        } catch(Exception ex){
            System.out.print(ex);
        }
